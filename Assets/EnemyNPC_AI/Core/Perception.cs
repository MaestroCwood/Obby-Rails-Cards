...
public class Perception : MonoBehaviour
{
    ...
    public bool isPickUpBrainRot = false;

        private void OnEnable()
        {
            GameEvents.OnPickUpBrainRot += OnPickBrainrot;
        }
        ...
        private void OnPickBrainrot(bool obj)
        {
            isPickUpBrainRot = obj;
        }
    ...
    {   
        ...
        if (distToTarget <= viewRadius && isPickUpBrainRot)
        {
